...
* Backup and restore data. For more detailed information,
  refer to [Consul Backup Daemon Guide](https://git.netcracker.com/PROD.Platform.Streaming/consul-backup-daemon/-/blob/master/documentation/maintenance-guide/development-guide/README.md).
