...
| `server.livenessProbe.enabled`              | boolean | no        | true                                                                          | Whether the liveness probe for the Consul server container is to be configured. If it is set to `false`, no liveness probe is added to the container.                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| `server.livenessProbe.initialDelaySeconds`  | integer | no        | 0                                                                             | The number of seconds after the container has started before the liveness probe is initiated.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| `server.livenessProbe.periodSeconds`        | integer | no        | 10                                                                            | How often (in seconds) the liveness probe is to be performed.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| `server.livenessProbe.timeoutSeconds`       | integer | no        | 1                                                                             | The number of seconds after which the liveness probe times out.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| `server.livenessProbe.successThreshold`     | integer | no        | 1                                                                             | The minimum number of consecutive successes for the liveness probe to be considered successful after having failed.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| `server.livenessProbe.failureThreshold`     | integer | no        | 3                                                                             | The number of consecutive failures for the liveness probe to be considered failed, after which the container is restarted.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| `server.readinessProbe.enabled`             | boolean | no        | true                                                                          | Whether the readiness probe for the Consul server container is to be configured. If it is set to `false`, no readiness probe is added to the container.                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| `server.readinessProbe.initialDelaySeconds` | integer | no        | 5                                                                             | The number of seconds after the container has started before the readiness probe is initiated.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| `server.readinessProbe.periodSeconds`       | integer | no        | 3                                                                             | How often (in seconds) the readiness probe is to be performed.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| `server.readinessProbe.timeoutSeconds`      | integer | no        | 5                                                                             | The number of seconds after which the readiness probe times out.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| `server.readinessProbe.successThreshold`    | integer | no        | 1                                                                             | The minimum number of consecutive successes for the readiness probe to be considered successful after having failed.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| `server.readinessProbe.failureThreshold`    | integer | no        | 2                                                                             | The number of consecutive failures for the readiness probe to be considered failed, after which the pod is marked as not ready.                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
