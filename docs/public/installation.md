...
| `ui.envoyGateway.enabled`    | boolean | no        | true                                                                  | Enables creation of a Gateway API HTTPRoute resource to expose the Consul UI via Envoy Gateway.                                                                                                                                                                                                                                                                                                                                                                                                                          |
| `ui.envoyGateway.host`       | string  | no        | ""                                                                    | Specifies the hostname used in the generated HTTPRoute for accessing the Consul UI.                                                                                                                                                                                                                                                                                                                                                                                                                                      |
