...
[Deployment Status Provisioner](https://github.com/netcracker/deployment-status-provisioner/blob/main/README.md).
...
During upgrade to `1.14.4` Consul (consul-service 0.2.0),
