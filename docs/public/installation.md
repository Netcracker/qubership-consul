...
| `consulAclConfigurator.namespaces`                | string  | no        | ""                                | The list of Kubernetes namespaces which watched by Consul ACL Configurator operator. Use "*" to watch all namespaces.                                                                                                                                                                                                                                                                                                                                                |
