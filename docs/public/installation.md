...
| `ui.envoyGateway.port`       | string  | no        | ""                                                                    | Specifies the gateway listener port for the main HTTPS HTTPRoute's parentRefs, skipped if unset.                                                                                                                                                                                                                                                                                                                                                                                           |
| `ui.envoyGateway.redirectPort`       | string  | no        | ""                                                                    | Specifies the gateway listener port for the HTTP to HTTPS redirect HTTPRoute's parentRefs, skipped if unset.                                                                                                                                                                                                                                                                                                                                                                                           |
